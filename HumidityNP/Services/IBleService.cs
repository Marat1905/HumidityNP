...
namespace HumidityNP.Services
{
    ...
    public interface IBleService : IDisposable
    {
        ...
        /// <summary>
        /// Последние полученные данные от влагомера (может быть null, если данные ещё не приходили).
        /// </summary>
        ParsedHumidityData? LastData { get; }

        /// <summary>
        /// Флаг, указывающий, что сейчас выполняется попытка подключения (чтобы не запускать повторно).
        /// </summary>
